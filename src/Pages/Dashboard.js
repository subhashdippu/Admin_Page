                            ...
                            <div className="nav">
                                ...
                                <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav">
                                        <Link className="nav-link" to='/Layoutstatic'>Static Navigation</Link>
                                        <Link className="nav-link" to='/Layoutsidenavlight'> Light Sidenav</Link>
                                    </nav>
                                </div>
                                ...
                                <div className="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                    <nav className="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                        ...
                                        <div className="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                            <nav className="sb-sidenav-menu-nested nav">
                                                <Link className="nav-link" to="/Error401">401 Page</Link>
                                                <Link className="nav-link" to="/Error404">404 Page</Link>
                                                <Link className="nav-link" to="/Error500">500 Page</Link>
                                            </nav>
                                        </div>
                                    </nav>
                                </div>
